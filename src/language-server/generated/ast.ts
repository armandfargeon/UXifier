...
export type UxifierAstType = 'App' | 'Color' | 'FQN' | 'Header' | 'Hidden' | 'Line' | 'Menu' | 'ModeType' | 'Page' | 'Platform' | 'Plugins' | 'Theme' | 'Widget' | 'WidgetWrapper' | 'AbstractWidget' | 'Popup' | 'ClassicWidget' | 'ColumnChartWidget' | 'LineChartWidget' | 'PolarChartWidget';
...
export class UxifierAstReflection implements AstReflection {
    ...
    getAllTypes(): string[] {
        return ['App', 'Color', 'FQN', 'Header', 'Hidden', 'Line', 'Menu', 'ModeType', 'Page', 'Platform', 'Plugins', 'Theme', 'Widget', 'WidgetWrapper', 'AbstractWidget', 'Popup', 'ClassicWidget', 'ColumnChartWidget', 'LineChartWidget', 'PolarChartWidget'];
    }
